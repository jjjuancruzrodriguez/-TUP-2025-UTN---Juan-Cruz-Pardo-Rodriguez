...
class HoverFrame(QFrame):
    def __init__(self):
        super().__init__()
        self.default_style = "background-color:#1B2838; border-radius:10px; padding:10px; border:1px solid #2A475E;"
        self.hover_style = "background-color:#2A475E; border-radius:10px; padding:10px; border:1px solid #3E5C7C;"
...
class GameTrackerApp(QWidget):
    ...
    # --- Función actualizada con géneros ---
    def crear_tarjeta_horizontal(self, game):
        ...
        if cover_id:
            ...
            worker.signals.finished.connect(partial(self.set_pixmap, cover_label, 250))
